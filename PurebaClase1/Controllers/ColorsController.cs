...
namespace PurebaClase1.Controllers
{
    public class ColorsController : Controller
    {
        ...
        public ColorsController(ProyectoBDContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Colors != null ? 
                          ...
                          Problem("Entity set 'ProyectoBDContext.Colors'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdColor,Descripcion")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdColor,Descripcion")] Color color)
        {
            if (id != color.IdColor)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProyectoBDContext.Colors'  is null.");
            }
            var color = await _context.Colors.FindAsync(id);
            if (color != null)
            {
